...
class StatisticsHomeActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun initView() {
        ...
        tv_title.text = resources.getText(R.string.preject_function3)
    }
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.title_bar_left_menu -> this@StatisticsHomeActivity.finish()
        }
    }
}